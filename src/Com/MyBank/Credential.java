...
public class Credential extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String subject="Mail from WebBank to your reset password"; // mail subject line
		String msg="http://localhost:8080/MyBank/Changeforgetpassword.html"; //mail body
		...
		response.sendRedirect("/MyBank/Sent.html");
